...
export const Route = createFileRoute("/verfcalculator")({
  head: () => ({
    meta: [
      { title: "Verfcalculator: bereken hoeveel verf je nodig hebt | Verfwinkel" },
      ...
      { property: "og:title", content: "Verfcalculator: bereken hoeveel verf je nodig hebt | Verfwinkel" },
