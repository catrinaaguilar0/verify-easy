...
export const Route = createFileRoute("/verfmengservice")({
  head: () => ({
    meta: [
      { title: "Verfmengservice — laat jouw kleur op maat mengen | Nieuweverf" },
      ...
      { property: "og:title", content: "Verfmengservice — kleur op maat | Nieuweverf" },
      ...
      { name: "twitter:title", content: "Verfmengservice | Nieuweverf" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          provider: { "@type": "Organization", name: "Nieuweverf", url: SITE_URL },
          areaServed: "NL",
