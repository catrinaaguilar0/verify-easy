      ...
      <main>
        ...
        <section id="inspiratie" className="border-y border-border bg-surface">
          <div className="container mx-auto px-4 py-16">
            ...
            {/* Kleurtrends 2026 — onderdeel van Inspiratie */}
            <div className="mt-14">
              <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                <div className="max-w-xl">
                  <span className="text-xs font-semibold uppercase tracking-wider text-accent">Kleurtrends 2026</span>
                  <h3 className="mt-2 text-xl font-bold text-ink md:text-2xl">De kleuren van het jaar 2026</h3>
              ...
              <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                ...
                <article className="group flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-[var(--shadow-card)] md:col-span-2 lg:row-span-2">
                  ...
                  <div className="p-6">
                    ...
                    <h4 className="mt-2 text-xl font-bold text-ink">Secret Safari</h4>
                    <p className="mt-2 text-sm text-ink-soft">
                ...
                {[
                  ...
                  <article key={c.name} className="group flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-[var(--shadow-card)]">
                    ...
                    <div className="p-5">
                      ...
                      <h4 className="mt-1.5 text-base font-bold text-ink">{c.name}</h4>
